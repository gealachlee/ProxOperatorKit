...
from prox.group_prox import ProxL2_1over2
class FISTA(Model):
    ...
    def T(self, x, d, **kwargs):
        ...
        alpha=  0.1
        Tx = alpha*self.prox_func(z, self.gamma * tau) +(1-alpha)*self.prox_func(x, self.gamma * tau)
